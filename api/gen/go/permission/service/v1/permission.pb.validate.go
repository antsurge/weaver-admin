...
// Validate checks the field values on PermissionTreeResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *PermissionTreeResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PermissionTreeResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// PermissionTreeResponseMultiError, or nil if none found.
func (m *PermissionTreeResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *PermissionTreeResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetData() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, PermissionTreeResponseValidationError{
			...
			if err := v.Validate(); err != nil {
				return PermissionTreeResponseValidationError{
					field:  fmt.Sprintf("Data[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return PermissionTreeResponseMultiError(errors)
	}

	return nil
}

// PermissionTreeResponseMultiError is an error wrapping multiple validation
// errors returned by PermissionTreeResponse.ValidateAll() if the designated
// constraints aren't met.
type PermissionTreeResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PermissionTreeResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PermissionTreeResponseMultiError) AllErrors() []error { return m }

// PermissionTreeResponseValidationError is the validation error returned by
// PermissionTreeResponse.Validate if the designated constraints aren't met.
type PermissionTreeResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PermissionTreeResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PermissionTreeResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PermissionTreeResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PermissionTreeResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PermissionTreeResponseValidationError) ErrorName() string {
	return "PermissionTreeResponseValidationError"
}

// Error satisfies the builtin error interface
func (e PermissionTreeResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sPermissionTreeResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = PermissionTreeResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = PermissionTreeResponseValidationError{}
