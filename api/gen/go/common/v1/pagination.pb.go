...
func (x *PaginationParams) GetCurrentPage() int64 {
	if x != nil {
...
func (x *PaginationParams) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
const file_common_v1_pagination_proto_rawDesc = "" +
	...
	"\bPageSize\x18\x02 \x01(\x03R\bPageSizeB\xa6\x01\n" +
	"\rcom.common.v1B\x0fPaginationProtoP\x01Z?github.com/hypercoze/kratos-admin/api/gen/go/common/v1;commonpb\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
