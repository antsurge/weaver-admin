...
func (c *authenticationServiceClient) GetCaptcha(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetCaptchaResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *authenticationServiceClient) CurrentUserInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CurrentUserInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
var AuthenticationService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "authentication/service/v1/authentication_service.proto",
}
