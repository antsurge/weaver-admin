...
func (Menu) Fields() []ent.Field {
	return []ent.Field{
		...
		field.String("badge_content").Default("").MaxLen(10).Comment("徽标内容"),
		field.String("badge_style").Default("").MaxLen(20).Comment("徽标样式:default/destructive/primary/success/warning"),
