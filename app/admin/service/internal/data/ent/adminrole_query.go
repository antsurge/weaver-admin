...
func (_q *AdminRoleQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *AdminRoleQuery) FirstIDX(ctx context.Context) string {
...
func (_q *AdminRoleQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *AdminRoleQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *AdminRoleQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *AdminRoleQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AdminRoleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(adminrole.Table, adminrole.Columns, sqlgraph.NewFieldSpec(adminrole.FieldID, field.TypeString))
	_spec.From = _q.sql
