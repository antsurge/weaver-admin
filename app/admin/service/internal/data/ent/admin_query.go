...
func (_q *AdminQuery) QueryRoles() *RoleQuery {
...
func (_q *AdminQuery) WithRoles(opts ...func(*RoleQuery)) *AdminQuery {
	query := (&RoleClient{config: _q.config}).Query()
...
func (_q *AdminQuery) loadRoles(ctx context.Context, query *RoleQuery, nodes []*Admin, init func(*Admin), assign func(*Admin, *Role)) error {
