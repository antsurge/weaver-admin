...
func (_c *DictTypeCreate) SetStatus(v dicttype.Status) *DictTypeCreate {
	_c.mutation.SetStatus(v)
	return _c
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_c *DictTypeCreate) SetNillableStatus(v *dicttype.Status) *DictTypeCreate {
	if v != nil {
		_c.SetStatus(*v)
	}
	return _c
...
func (_c *DictTypeCreate) SetID(v string) *DictTypeCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *DictTypeCreate) check() error {
	...
	if _, ok := _c.mutation.Code(); !ok {
		return &ValidationError{Name: "code", err: errors.New(`ent: missing required field "DictType.code"`)}
	}
...
func (_c *DictTypeCreate) sqlSave(ctx context.Context) (*DictType, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected DictType.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *DictTypeCreate) createSpec() (*DictType, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(dicttype.Table, sqlgraph.NewFieldSpec(dicttype.FieldID, field.TypeString))
	)
