...
func (_q *RoleMenuQuery) QueryRole() *RoleQuery {
...
func (_q *RoleMenuQuery) QueryMenu() *MenuQuery {
...
func (_q *RoleMenuQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *RoleMenuQuery) FirstIDX(ctx context.Context) string {
...
func (_q *RoleMenuQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *RoleMenuQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *RoleMenuQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *RoleMenuQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *RoleMenuQuery) WithRole(opts ...func(*RoleQuery)) *RoleMenuQuery {
	query := (&RoleClient{config: _q.config}).Query()
...
func (_q *RoleMenuQuery) WithMenu(opts ...func(*MenuQuery)) *RoleMenuQuery {
	query := (&MenuClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RoleMenuQuery) loadRole(ctx context.Context, query *RoleQuery, nodes []*RoleMenu, init func(*RoleMenu), assign func(*RoleMenu, *Role)) error {
...
func (_q *RoleMenuQuery) loadMenu(ctx context.Context, query *MenuQuery, nodes []*RoleMenu, init func(*RoleMenu), assign func(*RoleMenu, *Menu)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*RoleMenu)
	for i := range nodes {
		fk := nodes[i].MenuID
