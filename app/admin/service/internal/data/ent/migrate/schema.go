...
var (
	...
	MenuColumns = []*schema.Column{
		...
		{Name: "badge_content", Type: field.TypeString, Size: 10, Comment: "徽标内容", Default: ""},
		{Name: "badge_style", Type: field.TypeString, Size: 20, Comment: "徽标样式:default/destructive/primary/success/warning", Default: ""},
		{Name: "weight", Type: field.TypeInt, Comment: "权重", Default: 0},
		{Name: "status", Type: field.TypeEnum, Comment: "状态：enabled=启用 disabled=禁用", Enums: []string{"enabled", "disabled"}, Default: "enabled"},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
