...
func (_c *PositionCreate) SetWeight(v int) *PositionCreate {
	_c.mutation.SetWeight(v)
	return _c
}

// SetNillableWeight sets the "weight" field if the given value is not nil.
func (_c *PositionCreate) SetNillableWeight(v *int) *PositionCreate {
	if v != nil {
		_c.SetWeight(*v)
	}
	return _c
...
func (_c *PositionCreate) check() error {
	...
	if _, ok := _c.mutation.Weight(); !ok {
		return &ValidationError{Name: "weight", err: errors.New(`ent: missing required field "Position.weight"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
