...
import type { NormalMenuProps } from './index';
...
<template>
    <ul :class="[
        ...
        <template v-for="menu in menus" :key="menu.path">
            <li :class="[e('item'), is('active', activePath === menu.path)]" @click="() => emit('select', menu)"
                @mouseenter="() => emit('enter', menu)">
                <a-icon :class="e('icon')" :component="menuIcon(menu)" />
